...
angular.module('ntd.directives').directive('cascadeList', ['$parse', function($parse) {
  ...
  function onItemClick(e) {
    ...
    //滚动条
    var height=$('ul.selective').scrollTop();
    $('ul.selective').scrollTop((event.y>290)?height+50:height-50);
    
    // var height=$element.scrollTop();
    // $element.scrollTop((event.y>290)?height+22:height-22);
